  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-sans" dir="rtl">
      ...
      <main className="flex-1 pb-12 pt-24">
        ...
        {/* הסיפור שלנו */}
        <section id="about" className="px-6 py-20 bg-primary/5 my-12 rounded-[3.5rem] mx-6 border border-primary/10">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-4xl font-black mb-12 tracking-tight">הסיפור שלנו</h3>
            
            <div className="space-y-8 text-slate-700 dark:text-slate-300 text-xl leading-relaxed">
              <div className="space-y-2">
                <p className="font-medium">הכל התחיל מחשק אמיתי ללחם טוב כזה איכותי בלי פשרות</p>
                <p className="font-medium">הרצון לייצר לחם שעונה על הצרכים של כולם</p>
                <p className="font-bold text-primary/80">תערובת קמחים ללא גלוטן , כוסמין מלא, חיטה מלאה</p>
              </div>

              <div className="w-12 h-[1px] bg-primary/20 mx-auto my-8" />

              <div className="space-y-4">
                <p className="font-medium">אצלנו המחמצת עוברת תסיסה ארוכה של 24 שעות להעמקת טעמים ולהגיע למרקם נכון יותר</p>
                <p className="font-medium">כל לחם שתזמינו נעשה במיוחד עבורכם מקמחי מקור איכותיים ומחמצת טבעית בלבד בלי שמרים תעשייתיים ובלי שום קיצורי דרך</p>
              </div>
            ...
            <div className="mt-16 flex justify-center gap-4 opacity-30">
              ...
              <span className="font-black text-primary tracking-[0.3em] uppercase text-xs">Sabrosa</span>
              <div className="h-[1px] w-12 bg-primary self-center" />
            </div>
          </div>
        </section>
